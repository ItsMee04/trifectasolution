...
@section('content')
            ...
            <div class="page-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        ...
                        <h6>Manage your category product</h6>
                    </div>
                </div>
                ...
                <div class="page-btn">
                    <a class="modal-effect btn btn-added" data-bs-effect="effect-sign" data-bs-toggle="modal"
                        href="#modaladd"><i data-feather="plus-circle" class="me-2"></i>Add Category Product</a>
                </div>
            </div>
                                ...
                                @foreach ($category as $item)
                                    <tr>
                                        ...
                                        <td class="action-table-data">
                                            <div class="edit-delete-action">
                                                ...
                                                <a class="me-2 p-2" onclick="confirm_modal('category/{{ $item->id }}');"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered text-center" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Edit Category Product</h4><button
                                                    ...
                                                    <div class="modal-body text-start">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="category"
                                                                value="{{ $item->category }}" class="form-control">
                                                        </div>
                                                        <div class="mb-3">
                                    ...
                                    <div class="modal fade" id="modaldetail{{ $item->id }}">
                                        <div class="modal-dialog modal-dialog-centered text-center" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Detail Category Product</h4><button
                                                        aria-label="Close" class="btn-close"
                                                        data-bs-dismiss="modal"></button>
                                                </div>
                                                <form action="category/{{ $item->id }}" method="POST"
                                                    ...
                                                    <div class="modal-body text-start">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label">Description</label>
                                                            <textarea class="form-control" rows="4" name="description" readonly>{{ $item->description }}</textarea>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label">Status</label>
                                                            @if ($item->status == 1)
    ...
    <div class="modal fade" id="modaladd">
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h4 class="modal-title">Create Category Product</h4><button aria-label="Close" class="btn-close"
                        data-bs-dismiss="modal"></button>
                </div>
