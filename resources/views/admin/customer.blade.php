...
@section('content')
            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a class="modal-effect btn btn-added" data-bs-effect="effect-sign" data-bs-toggle="modal"
                        href="#modaladd"><i data-feather="plus-circle" class="me-2"></i>Add Customer</a>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-table-data">
                                            <div class="edit-delete-action">
                                                ...
                                                <a class="me-2 p-2" onclick="confirm_modal('customer/{{ $item->id }}');"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered text-center" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Edit Customer</h4><button aria-label="Close"
                                                ...
                                                <form action="customer/{{ $item->id }}" method="POST"
                                                    ...
                                                    <div class="modal-body text-start">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" rows="4" name="address">{{ $item->address }}</textarea>
                                                        </div>
                                                        <div class="mb-3">
                                            ...
                                            <div class="modal-content modal-content-demo">
                                                ...
                                                <form action="" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-body text-start">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label">Address</label>
                                                            <textarea class="form-control" rows="4" name="address" readonly>{{ $item->address }}</textarea>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label">Identity</label>
                                                            <input type="text" name="phone"
    ...
    <div class="modal fade" id="modaladd">
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h4 class="modal-title">Create Customer</h4><button aria-label="Close" class="btn-close"
