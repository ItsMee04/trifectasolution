...
@section('content')
            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a class="modal-effect btn btn-added" data-bs-effect="effect-sign" data-bs-toggle="modal"
                        href="#modaladd"><i data-feather="plus-circle" class="me-2"></i>Add Supplier</a>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-table-data">
                                            <div class="edit-delete-action">
                                                ...
                                                <a class="me-2 p-2" onclick="confirm_modal('supplier/{{ $item->id }}');"
    ...
    <div class="modal fade" id="modaladd">
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h4 class="modal-title">Create Supplier</h4><button aria-label="Close" class="btn-close"
