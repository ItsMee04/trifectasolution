...
(function () {
    ...
    /* Secondary toast js */
    const solidsecondaryToast = document.getElementById(
        "solidsecondaryToastBtn"
    );
    ...
    const soliddangertoastExample =
        document.getElementById("solid-dangerToast");
    if (soliddangerToast) {
    ...
    const middlerighttoastExample =
        document.getElementById("middleright-Toast");
    if (middlerightToast) {
    ...
    const bottomrighttoastExample =
        document.getElementById("bottomright-Toast");
    if (bottomrightToast) {
